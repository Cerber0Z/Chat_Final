...
const Register = () => {
    ...
    return (
        <div className="register">
            ...
            <input type="password" name="reEnterPassword" value={user.reEnterPassword} placeholder="Repetir Contraseña" onChange={ handleChange }></input>
            <div className="button" onClick={register} >Registrarse</div>
            <div>or</div>
            <div className="button" onClick={() => history.push("/login")}>Iniciar Sesion</div>
        </div>
    )
}
